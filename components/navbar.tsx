    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        <Link href="#home" className="text-2xl font-bold text-white" onClick={(e) => scrollToSection(e, "#home")}>
          Raykhona<span className="text-indigo-500">.</span>
        </Link>
        ...
        <div className="hidden md:flex space-x-8 items-center">
          {navLinks.map((link) => (
            ...
            >
              {link.name}
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-violet-600 to-indigo-600 transition-all duration-300 group-hover:w-full"></span>
            </Link>
          ))}
          <motion.a
          ...
          <motion.a
            href="https://github.com/raykhona-k"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-white transition-colors duration-300"
            aria-label="GitHub"
          ...
          <motion.a
            href="https://linkedin.com/in/raykhona-k"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-white transition-colors duration-300"
            aria-label="LinkedIn"
